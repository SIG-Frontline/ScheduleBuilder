    ...
    <>
      ...
      <div className="flex flex-col mx-6 gap-3">
        <Checkbox.Card
          ...
          onChange={(checked) => setInput({ ...input, isCommuter: checked })}
        >
          <Group wrap="nowrap" align="flex-start">
            ...
            <div>
              ...
              <Text size="xs" c="dimmed">
                Bias the organizer towards commuter schedules by including
                commute times
              </Text>
            </div>
          </Group>
          ...
          <Group wrap="nowrap" align="flex-start">
            <TextInput
              ...
              onChange={(e) =>
                setInput({
                  ...input,
                  commuteTime: e.currentTarget.value,
                })
              }
            />
          </Group>
        ...
        >
          <Group wrap="nowrap" align="flex-start">
            ...
            <div>
              ...
              <Text size="xs" c="dimmed">
                Bias the organized towards schedules with classes one after
                another
              </Text>
              <Text size="xs" c="red">
                WARNING: It is not recommended to have too many classes
                back-to-back, a break is recommended in between
              </Text>
            </div>
          </Group>
        </Checkbox.Card>
        ...
        <Text ta={'center'}>
          This will optimize the currently selected plan with the settings above
          to have the least amount of time on campus. Plans with more courses
